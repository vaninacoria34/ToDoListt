...
-- -----------------------------------------------------
-- Table `ToDoList`.`Categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ToDoList`.`Categoria` (
...
CREATE TABLE IF NOT EXISTS `ToDoList`.`Tarea` (
  ...
  PRIMARY KEY (`PK_Tarea`, `FK_Usuario`, `FK_Estado`, `FK_Prioridad`, `FK_Categoria`),
  ...
  INDEX `fk_Tarea_Categoría1_idx` (`FK_Categoria` ASC),
  ...
  CONSTRAINT `fk_Tarea_Categoría1`
    ...
    REFERENCES `ToDoList`.`Categoria` (`PK_Categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
